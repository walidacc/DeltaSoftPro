...
{
    public partial class returnGrid : UserControl
    {
        ...
        private void get_ItemData(int _rowIndex,string item_No)
        {
            ...
            ,(sum(V.QTY_Balance)+sum(V.Delever_BALANCE)) as BALANCE  
        ...
        private void dgv1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (j == dgv1.Columns[_code.Name].Index)
                {
                    ...
                    SendKeys.Send("{up}");
                    dgv1.CurrentCell = dgv1[dgv1.Columns[_addDescription.Name].Index, i];


                    //}
                }

                else if (j == dgv1.Columns[_addDescription.Name].Index)
                {
                    SendKeys.Send("{up}");
                ...
                else if (j == dgv1.Columns[_qty.Name].Index)
                {
                    if (isCellNotNull(j, i) == true && qtyOnly != true)
                    {
                        ...
                        SendKeys.Send("{up}");
                        dgv1.CurrentCell = dgv1[dgv1.Columns[_price.Name].Index, i];
                    }
                ...
                else if (j == dgv1.Columns[_totalWeight.Name].Index)
                {
                    clculatPeace();
                    clculat_amount(i);
                    SendKeys.Send("{up}");
                ...
                else if (j == dgv1.Columns[_price.Name].Index)
                {
                    ...
                    if (isCellNotNull(j, i) == true)
                    {
                        ...
                        clculat_amount(i);
                        SendKeys.Send("{up}");
                        dgv1.CurrentCell = dgv1[dgv1.Columns[_discount.Name].Index, i];
                    }
                    else
                    {
                        SendKeys.Send("{up}");
                ...
                else if (j == dgv1.Columns[_tonPrice.Name].Index)
                {
                    clculatPeacePrice();
                    clculat_amount(i);
                    SendKeys.Send("{up}");
                ...
                else if (j == dgv1.Columns[_discount.Name].Index)
                {
                    clculat_amount(i);
                    if (isCellNotNullSrting(dgv1.Columns[_code.Name].Index, i) == true && isCellNotNull(dgv1.Columns[_qty.Name].Index, i) == true && isCellNotNull(dgv1.Columns[_price.Name].Index, i) == true)
                    {
                        if (i < dgv1.Rows.Count - 1)
                        {
                            dgv1.CurrentCell = dgv1[dgv1.Columns[_code.Name].Index, i + 1];
        ...
        private void dgv1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
...

                {
                    ...
                    dgv1.CurrentCell = dgv1[dgv1.Columns[_addDescription.Name].Index, iRow];
                  
                }

                else if (iCol == dgv1.Columns[_addDescription.Name].Index)
                {
                ...
                else if (iCol == dgv1.Columns[_qty.Name].Index && isCellNotNull(iCol, iRow) == true)
                {
                    ...
                    if (isCellNotNullSrting(dgv1.Columns[_code.Name].Index, iRow) == true && isCellNotNull(dgv1.Columns[_qty.Name].Index, iRow) == true && qtyOnly == true)
                    {
                    ...
                    {
                        dgv1.CurrentCell = dgv1[dgv1.Columns[_price.Name].Index, iRow];
                    }
                }


                else if (iCol == dgv1.Columns[_totalWeight.Name].Index)
                {
                ...
                else if (iCol == dgv1.Columns[_price.Name].Index && isCellNotNull(iCol, iRow) == true)
                {
                    dgv1.CurrentCell = dgv1[dgv1.Columns[_discount.Name].Index, iRow];
                }
                   
                else if (iCol == dgv1.Columns[_tonPrice.Name].Index)
                {
                    dgv1.CurrentCell = dgv1[dgv1.Columns[_discount.Name].Index, iRow];
                }

                else if (iCol == dgv1.Columns[_discount.Name].Index)
                {
                    if (isCellNotNullSrting(dgv1.Columns[_code.Name].Index, iRow) == true && isCellNotNull(dgv1.Columns[_qty.Name].Index, iRow) == true && isCellNotNull(dgv1.Columns[_price.Name].Index, iRow) == true)
                    {
                        if (iRow < dgv1.Rows.Count - 1)
                        {
                            dgv1.CurrentCell = dgv1[dgv1.Columns[_code.Name].Index, iRow + 1];
           ...
           else if (e.KeyCode == Keys.F5 && iCol == dgv1.Columns[_price.Name].Index)
            {
                
                PL.list_H_price frm = new PL.list_H_price();
                frm.txtBranch.ID.Text = Properties.Settings.Default.BranchId;
                frm.txtItem.ID.Text = dgv1[dgv1.Columns[_code.Name].Index, iRow].Value.ToString();
            ...
            else if (e.KeyCode == Keys.F6 && iCol == dgv1.Columns[_price.Name].Index)
            {

...
namespace Report_Pro.RPT
{
...

    {
        ...
        private void reportPreview()
        {
            ...
            else if (rdoStockByBranches.Checked)
            {
                RPT.rpt_inventory_byBranch rpt = new RPT.rpt_inventory_byBranch();
                DataSet1 ds = new DataSet1();
                DataTable dt1 = new DataTable();
            ...
            else if (rdoItemBalanceByBranches.Checked)
            {
            ...
            else if (rdoStockStoreAndBranches.Checked)
            {
            ...
            else if (rdoStockMainAndBranches_Groups.Checked)
            {
            ...
            else if (rdoTotalInventoryList.Checked)
            {
            ...
            else if (rdoInventoryByGroups.Checked)
            {
                DataTable dt1 = new DataTable();
            ...
            else if (rdoTotalStockByBranch.Checked)
            {
                DataTable dt1 = new DataTable();

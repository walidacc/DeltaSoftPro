...
namespace Report_Pro.PL
{
    public partial class invoice_frm : frm_Master
    {
        ...
        public override void New()
        {
            ...
            txt_Acc.txtAccCash.Text = dal.GetCell_1("SELECT Cash_Costmer_Code FROM wh_BRANCHES  where BRANCH_code='" + txtStore_ID.Text + "'").ToString();
...
getSalesInv(Sh_ser, txtStore_ID.Text, sh_transaction, Properties.Settings.Default.C_year);
        ...
        private void Uc_Customer_Load(object sender, EventArgs e)
        {
            ...
            string Get_cust = @"SELECT p.ACC_NO,p.phone_no,p.fax_no,p.E_MAIL,p.COSTMER_K_M_NO
                            ...
                            FROM PAYER2 as P 
                            where  BRANCH_code='" + txt_Acc.branchID.Text + "' and (acc_no like '" + txt_Acc.txtMainAcc.Text + "%' or Acc_no like '" +txt_Acc.txtAccCash.Text + "')   and  ACC_NO ='" + txt_Acc.ID.Text + "'";

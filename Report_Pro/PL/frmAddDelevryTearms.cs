...
namespace Report_Pro.PL
{
    public partial class frmAddDelevryTearms : Form
    {
        ...
        {
            DataTable dt_ = dal.getDataTabl_1("select * from WH_PO_DELEVRY_CODE where DeLEVRY_CODE like '%" + txtCode.Text + "%' and DeLEVRY_Name like '%" + txtDesc.Text + "%' and DELEVER_NAME_E like '%" + txtDesc_L.Text + "%'");
            dt.Clear();
            int i = 0;
            DataRow row = null;
